...
export const SPEAKERS: Speaker[] = [
  ...
  {
    id: 'sp_galkin',
    name: 'Галкин Владислав Сергеевич',
    role: 'Управляющий партнёр',
    company: 'Юридическая компания «Галкин и партнёры»',
    bio: 'Эксперт в области банкротства физических лиц с 10-летним стажем.',
    avatarLetter: 'ГВ',
    topic: 'Стратегии защиты должников в 2026 году',
    trackId: 't_bfl',
    interestIds: ['bfl', 'courts', 'arbitrage'],
  },
  {
    id: 'sp_sokolov',
