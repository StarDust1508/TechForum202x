...
//   (80+) публикуется на tech-pravo.ru/conference. См. NEWS[0].
// END_INVARIANTS
//
...
// программы (tech-pravo.ru/conference). Финальный состав (80+) и тайм-слоты
...
export const PARTNERS: Partner[] = [
  ...
  { id: 'p_pravotech',   name: 'ПравоТех',               tier: 'Платиновый',      url: 'https://tech-pravo.ru',   description: 'Автоматизация, CRM и документооборот для юридических компаний.' },
  { id: 'p_neuropravo',  name: 'NeuroPravo',             tier: 'Технологический', url: 'https://tech-pravo.ru',   description: 'Промышленные ИИ-ассистенты и предиктивная аналитика для юрпрактики.' },
  { id: 'p_legaltech',   name: 'LegalTech Solutions',    tier: 'Золотой',         url: 'https://tech-pravo.ru',   description: 'Цифровые платформы и LLM-сервисы для юридического бизнеса.' },
  { id: 'p_galkin',      name: 'ЮК «Галкин и партнёры»', tier: 'Золотой',         url: 'https://tech-pravo.ru',   description: 'Юридическая компания, лидер федеральной БФЛ-практики.' },
  { id: 'p_sro_delo',    name: 'СРО «Дело»',             tier: 'Серебряный',      url: 'https://tech-pravo.ru',   description: 'Саморегулируемая организация арбитражных управляющих.' },
  { id: 'p_ailegal',     name: 'AI Legal',               tier: 'Технологический', url: 'https://tech-pravo.ru',   description: 'ИИ-инструменты и аналитика для юридического рынка.' },
];
