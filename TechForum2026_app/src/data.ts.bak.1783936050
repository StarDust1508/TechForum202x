...
// - Программа — ПРЕДВАРИТЕЛЬНАЯ и повторяет деловую программу с pravotech.pro/conference.
//   ФИО спикеров условные (закреплены под роли/компании из программы); финальный состав
//   (80+) публикуется на pravotech.pro/conference. См. NEWS[0].
// END_INVARIANTS
//
...
export const EVENT_META: EventMeta = {
  ...
  organizerEmail: 'pravotechhub@mail.ru',
  url: 'https://pravotech.pro',
};

// ============================================================================
// SECTION: TRACKS — 6 юридических потоков (как на pravotech.pro/conference)
// ============================================================================
...
// программы (pravotech.pro/conference). Финальный состав (80+) и тайм-слоты
...
export const SPEAKERS: Speaker[] = [
  {
    ...
    bio: 'Управляющий партнёр юридической компании «Галкин и партнёры». Специализация — банкротство физических лиц, построение и масштабирование юридической практики до федерального уровня.',
    avatarLetter: 'ДГ',
    topic: 'Масштабирование БФЛ-практики и управление юридической компанией',
    trackId: 't_growth',
    interestIds: ['bfl', 'growth', 'scaling', 'management', 'sales'],
  },
  {
    id: 'sp_sizov',
    name: 'Игорь Сизов',
    ...
    company: 'СРО «Дело»',
    bio: 'Арбитражный управляющий, член СРО «Дело». Практикующий эксперт по процедурам банкротства физлиц, судебной практике и оспариванию сделок.',
    avatarLetter: 'ИС',
    topic: 'Рынок БФЛ 2026: тренды, судебная практика, оспаривание сделок',
    trackId: 't_bfl',
    interestIds: ['bfl', 'arbitrage', 'courts'],
  },
  {
    id: 'sp_sokolov',
    name: 'Артём Соколов',
    ...
    bio: 'CEO LegalTech Solutions. Разрабатывает цифровые платформы и LLM-ассистентов для юридического бизнеса, эксперт по внедрению Legal Tech в практику.',
    avatarLetter: 'АС',
    topic: 'LLM-ассистенты и цифровые сервисы Legal Tech для юристов',
    trackId: 't_legaltech',
    interestIds: ['legaltech', 'ai_law', 'llm', 'platforms'],
  },
  {
    id: 'sp_lebedeva',
    ...
    company: 'ПравоТех',
    bio: 'Руководитель направления в ПравоТех. Отвечает за CRM, документооборот и автоматизацию процессов в юридических компаниях, а также за compliance и защиту персональных данных.',
    avatarLetter: 'МЛ',
    topic: 'Автоматизация практики, CRM/документооборот, 152-ФЗ',
    trackId: 't_automation',
    interestIds: ['automation', 'docs', 'crm', 'compliance', 'pdn'],
  },
  {
    id: 'sp_artemev',
    name: 'Павел Артемьев',
    role: 'CTO',
    company: 'NeuroPravo',
    bio: 'CTO NeuroPravo. Строит промышленные ИИ-ассистенты для юрпрактики и системы предиктивной аналитики судебных решений.',
    avatarLetter: 'ПА',
    topic: 'Предиктивная аналитика и промышленные ИИ-ассистенты для юрпрактики',
    trackId: 't_ai',
    interestIds: ['ai_law', 'llm', 'analytics', 'automation'],
  },
];
...
export const SESSIONS: Session[] = [
  ...
  buildSession({
    ...
    trackId: null, speakerIds: ['sp_galkin'],
    status: 'Soon',
  }),
  buildSession({
    id: 's_d1_bfl_market',
  ...
  buildSession({
    ...
    format: 'talk', hallId: 'zal_a', dayId: 'd1',
    trackId: 't_bfl', speakerIds: ['sp_galkin'],
    status: 'Soon',
  }),
  buildSession({
    id: 's_d1_crm',
  ...
  buildSession({
    ...
    trackId: null, speakerIds: ['sp_galkin', 'sp_sokolov', 'sp_artemev'],
    status: 'Soon',
  }),
  buildSession({
    id: 's_d1_networking',
  ...
  buildSession({
    ...
    trackId: 't_growth', speakerIds: ['sp_galkin'],
    status: 'Soon',
  }),
  buildSession({
    id: 's_d2_coffee1',
...
export const PARTNERS: Partner[] = [
  { id: 'p_legalhunter', name: 'LegalHunter',            tier: 'Генеральный',     url: 'https://legalhunter.pro', description: 'Платформа обучения и подбора специалистов по банкротству физлиц.' },
  { id: 'p_pravotech',   name: 'ПравоТех',               tier: 'Платиновый',      url: 'https://pravotech.pro',   description: 'Автоматизация, CRM и документооборот для юридических компаний.' },
  { id: 'p_neuropravo',  name: 'NeuroPravo',             tier: 'Технологический', url: 'https://pravotech.pro',   description: 'Промышленные ИИ-ассистенты и предиктивная аналитика для юрпрактики.' },
  { id: 'p_legaltech',   name: 'LegalTech Solutions',    tier: 'Золотой',         url: 'https://pravotech.pro',   description: 'Цифровые платформы и LLM-сервисы для юридического бизнеса.' },
  { id: 'p_galkin',      name: 'ЮК «Галкин и партнёры»', tier: 'Золотой',         url: 'https://pravotech.pro',   description: 'Юридическая компания, лидер федеральной БФЛ-практики.' },
  { id: 'p_sro_delo',    name: 'СРО «Дело»',             tier: 'Серебряный',      url: 'https://pravotech.pro',   description: 'Саморегулируемая организация арбитражных управляющих.' },
  { id: 'p_ailegal',     name: 'AI Legal',               tier: 'Технологический', url: 'https://pravotech.pro',   description: 'ИИ-инструменты и аналитика для юридического рынка.' },
];
...
export const NEWS: NewsItem[] = [
  {
    id: 'n1',
    type: 'Важно',
    title: 'Опубликована предварительная программа конференции',
    content: 'ТехнологИИ Права 2026 — 25–26 сентября, Москва, БЦ «Красные Ворота». Программа предварительная.',
    body: 'Опубликована предварительная деловая программа конференции «ТехнологИИ Права 2026» (25–26 сентября 2026, Москва, БЦ «Красные Ворота», Садовая-Спасская 21/1). Программа включает 6 тематических потоков: банкротство физлиц, ИИ в юрбизнесе, автоматизация практики, Legal Tech и сервисы, рост и масштабирование, данные и безопасность. Обратите внимание: программа предварительная, возможны изменения. Финальный состав спикеров (80+) и закреплённые тайм-слоты публикуются и обновляются на странице конференции pravotech.pro/conference.',
    time: 'Сегодня · 17:05',
    isCritical: true,
  ...
  },
  {
    id: 'n2',
    type: 'Программа',
    title: '6 потоков и два дня насыщенной программы',
    content: 'БФЛ, ИИ в юрбизнесе, автоматизация, Legal Tech, рост практики, данные и безопасность.',
    body: 'Деловая программа распределена по 6 потокам и двум дням. День 1 (25 сентября) — фокус на банкротстве физлиц, ИИ-ассистентах и автоматизации, панельная дискуссия «ИИ и будущее юридической профессии». День 2 (26 сентября) — защита данных и 152-ФЗ, мастер-класс по автоматизации документов БФЛ, кейсы Legal Tech, демо ИИ-ассистентов, награждение БФЛ-практик года. Рекомендуем заранее записаться на сессии в разделе «Программа» — по части воркшопов места ограничены вместимостью зала.',
    time: 'Сегодня · 15:20',
    isCritical: false,
    category: 'Программа',
  },
  {
    id: 'n3',
    type: 'Спикер',
    title: 'Открытие и keynote по рынку банкротства физлиц',
    content: 'Первый день откроют организаторы, затем — обзор рынка БФЛ 2026.',
    body: 'Первый день конференции откроется торжественным словом организаторов в Зале А в 10:00. Сразу за открытием — keynote «Рынок банкротства физлиц 2026: тренды, цифры, прогнозы» от арбитражного управляющего СРО «Дело». В докладе — динамика процедур, ключевые цифры года и прогнозы на 2026.',
    time: 'Сегодня · 14:40',
    isCritical: false,
  ...
  },
  {
    id: 'n4',
    type: 'AI',
    title: 'LLM-ассистенты и предиктивная аналитика для юристов',
    content: 'Отдельный поток «ИИ в юрбизнесе»: возможности, риски и живые демо.',
    body: 'Поток «ИИ в юрбизнесе» соберёт доклады о применении больших языковых моделей в работе юриста, предиктивной аналитике судебных решений и промышленных ИИ-ассистентах. В программе — честный разбор возможностей и рисков, а во второй день — живое демо промышленных ИИ-ассистентов для юрпрактики.',
    time: 'Вчера · 18:10',
    isCritical: false,
    category: 'ИИ в юрбизнесе',
    speakerId: 'sp_artemev',
  },
  {
    id: 'n5',
    type: 'Программа',
    title: 'Панельная дискуссия: ИИ и будущее юридической профессии',
    content: 'Финал первого дня — открытая дискуссия спикеров конференции.',
    body: 'Первый день завершится открытой панельной дискуссией «ИИ и будущее юридической профессии» в Зале А (16:30–17:30). Участники — спикеры конференции из юридической практики и Legal Tech. Темы: как ИИ меняет профессию юриста, где границы автоматизации, регуляторные риски и тренды рынка. После — вечерний нетворкинг в лаунж-зоне.',
    time: 'Вчера · 12:25',
    isCritical: false,
    category: 'Программа',
  },
  {
    id: 'n6',
    type: 'Спикер',
    title: 'Защита персональных данных и 152-ФЗ',
    content: 'Второй день откроет доклад по compliance и защите ПДн в юркомпании.',
    body: 'Второй день начнётся с доклада «Защита персональных данных и compliance (152-ФЗ)» в Зале А (10:00–11:00). Речь пойдёт о практике соблюдения 152-ФЗ в юридической компании: обработка персональных данных, согласия, риски и проверки РКН. Параллельно в Зале В — мастер-класс по автоматизации подготовки документов БФЛ.',
    time: '2 дня назад · 11:50',
    isCritical: false,
    category: 'Данные и безопасность',
    speakerId: 'sp_lebedeva',
  },
];
