...
export const DEFAULT_APP_CONTENT: AppContent = {
  ...
  researchLawyerMaterial: 'Описание материала управляется удалённо и требует подтверждения контент-владельца перед показом.',
  ...
  researchManagerMaterial: 'Описание материала управляется удалённо и требует подтверждения контент-владельца перед показом.',
