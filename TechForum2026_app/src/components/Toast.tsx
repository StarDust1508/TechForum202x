        ...
        <AnimatePresence>
          {toasts.map((t) => (
            <motion.div
              ...
              className="pointer-events-auto rounded-2xl bg-[#0a2f38]/95 backdrop-blur-md border border-[#4ec9c0]/30 px-5 py-3 shadow-[0_8px_28px_rgba(94,234,212,0.18)] text-[13px] font-semibold text-white/95 max-w-[90vw]"
            >
              {t.message}
            </motion.div>
          ))}
